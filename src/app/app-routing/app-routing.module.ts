...
import { LoginComponent } from
 '../components/pages/account/login/login.component';
import { RegisterComponent } from
 '../components/pages/account/register/register.component';
import { PasswordComponent } from
 '../components/pages/account/password/password.component';
